...
class Adafactor(Optimizer):
    ...
    ```python
    from transformers_local.optimization import Adafactor, AdafactorSchedule
    ...
    def _approx_sq_grad(exp_avg_sq_row, exp_avg_sq_col):
        ...
        # https://github.com/huggingface/transformers_local/blob/8395f14de6068012787d83989c3627c3df6a252b/src/transformers_local/optimization.py#L505
