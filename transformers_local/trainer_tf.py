...
class TFTrainer:
    ...
    def __init__(
        ...
        warnings.warn(
            ...
            "examples at https://github.com/huggingface/transformers_local/tree/master/examples/tensorflow",
            FutureWarning,
        )
    ...
    def setup_comet(self):
        ...
        if experiment is not None:
            experiment._set_model_graph(self.model, framework="transformers_local")
            experiment._log_parameters(self.args, prefix="args/", framework="transformers_local")
            experiment._log_parameters(self.model.config, prefix="config/", framework="transformers_local")
        ...
        if is_comet_available():
            ...
            if experiment is not None:
                experiment._log_metrics(
                    logs, step=self.global_step, epoch=self.epoch_logging, framework="transformers_local"
                )
