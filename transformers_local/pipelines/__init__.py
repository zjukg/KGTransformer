...
def get_task(model: str, use_auth_token: Optional[str] = None) -> str:
    ...
    if data.get("library_name", "transformers_local") != "transformers_local":
        raise RuntimeError(f"This model is meant to be used with {data['library_name']} not with transformers_local")
