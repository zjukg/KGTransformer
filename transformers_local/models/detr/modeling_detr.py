...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import DetrFeatureExtractor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import DetrFeatureExtractor, DetrForObjectDetection
        >>> from PIL import Image
        >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import DetrFeatureExtractor, DetrForSegmentation
        >>> from PIL import Image
        >>> import requests
