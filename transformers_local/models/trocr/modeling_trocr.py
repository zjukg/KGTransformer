...
# Copied from transformers_local.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->TrOCR
...
class TrOCRForCausalLM(TrOCRPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import VisionEncoderDecoderModel, TrOCRForCausalLM, ViTModel, TrOCRConfig, ViTConfig
