...
# Copied from transformers_local.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->RoFormer
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfOutput with Bert->RoFormer
...
# Copied from transformers_local.models.bert.modeling_bert.BertIntermediate with Bert->RoFormer
...
# Copied from transformers_local.models.bert.modeling_bert.BertOutput with Bert->RoFormer
...
# Copied from transformers_local.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoFormer
...
class RoFormerForCausalLM(RoFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import RoFormerTokenizer, RoFormerForCausalLM, RoFormerConfig
        >>> import torch
