...
class XLMProphetNetEncoder(ProphetNetEncoder):
    ...
    ```python
    >>> from transformers_local import XLMProphetNetTokenizer, XLMProphetNetEncoder
    >>> import torch
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    ...
    ```python
    >>> from transformers_local import XLMProphetNetTokenizer, XLMProphetNetDecoder
    >>> import torch
...
class XLMProphetNetModel(ProphetNetModel):
    ...
    ```python
    >>> from transformers_local import XLMProphetNetTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    ...
    ```python
    >>> from transformers_local import XLMProphetNetTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    ...
    ```python
    >>> from transformers_local import XLMProphetNetTokenizer, XLMProphetNetForCausalLM
    >>> import torch
    ...
    >>> from transformers_local import EncoderDecoderModel, XLMProphetNetTokenizer, XLMRobertaTokenizer
    >>> import torch
