...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->Blenderbot
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Blenderbot
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from transformers_local import BlenderbotTokenizer, BlenderbotForConditionalGeneration >>> mname =
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import BlenderbotTokenizer, BlenderbotModel
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->Blenderbot
...
# Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM with Bart->Blenderbot, facebook/bart-large->facebook/blenderbot-400M-distill
class BlenderbotForCausalLM(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import BlenderbotTokenizer, BlenderbotForCausalLM
