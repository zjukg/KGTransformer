...
class ElectraEmbeddings(nn.Module):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertEmbeddings.forward
    def forward(
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfAttention with Bert->Electra
...
# Copied from transformers_local.models.bert.modeling_bert.BertAttention with Bert->Electra
...
# Copied from transformers_local.models.bert.modeling_bert.BertLayer with Bert->Electra
...
# Copied from transformers_local.models.bert.modeling_bert.BertEncoder with Bert->Electra
...
class ElectraForPreTraining(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ElectraTokenizer, ElectraForPreTraining
        >>> import torch
...
class ElectraForCausalLM(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ElectraTokenizer, ElectraForCausalLM, ElectraConfig
        >>> import torch
    ...
    # Copied from transformers_local.models.roberta.modeling_roberta.RobertaForCausalLM.prepare_inputs_for_generation
    ...
    # Copied from transformers_local.models.roberta.modeling_roberta.RobertaForCausalLM._reorder_cache
