...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfAttention with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfOutput with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertAttention with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertIntermediate
...
# Copied from transformers_local.models.bert.modeling_bert.BertOutput with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertLayer with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertEncoder with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertPooler
...
# Copied from transformers_local.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertLMPredictionHead with Bert->LayoutLM
...
# Copied from transformers_local.models.bert.modeling_bert.BertOnlyMLMHead with Bert->LayoutLM
...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import LayoutLMTokenizer, LayoutLMModel
        >>> import torch
...
class LayoutLMForMaskedLM(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import LayoutLMTokenizer, LayoutLMForMaskedLM
        >>> import torch
...
class LayoutLMForSequenceClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import LayoutLMTokenizer, LayoutLMForSequenceClassification
        >>> import torch
...
class LayoutLMForTokenClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import LayoutLMTokenizer, LayoutLMForTokenClassification
        >>> import torch
