...
PERCEIVER_MODEL_START_DOCSTRING = r"""
    ...
    Parameters:
        ...
        decoder (*DecoderType*, *optional*):
            ...
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverBasicDecoder*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverClassificationDecoder*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverMultimodalDecoder*.
        input_preprocessor (*PreprocessorType*, *optional*):
            Optional input preprocessor to use. Examples include
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverImagePreprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverAudioPreprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverTextPreprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverMultimodalPreprocessor*.
        output_postprocessor (*PostprocessorType*, *optional*):
            Optional output postprocessor to use. Examples include
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverImagePostprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverAudioPostprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverClassificationPostprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverProjectionPostprocessor*,
            *transformers_local.models.perceiver.modeling_perceiver.PerceiverMultimodalPostprocessor*.
...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverConfig, PerceiverTokenizer, PerceiverFeatureExtractor, PerceiverModel
        >>> from transformers_local.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverFeatureExtractor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverFeatureExtractor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverFeatureExtractor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np
