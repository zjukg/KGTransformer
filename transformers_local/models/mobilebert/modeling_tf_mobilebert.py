...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_local import MobileBertTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_local import MobileBertTokenizer, TFMobileBertForNextSentencePrediction
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForNextSentencePrediction.serving_output
