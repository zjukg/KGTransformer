...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfOutput
...
class TapasAttention(nn.Module):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertAttention.prune_heads
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertAttention.forward
    def forward(
        self,
        hidden_states,
        attention_mask=None,
...
# Copied from transformers_local.models.bert.modeling_bert.BertOutput
...
class TapasLayer(nn.Module):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertLayer.forward
    def forward(
        self,
        hidden_states,
        attention_mask=None,
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertLayer.feed_forward_chunk
...
# Copied from transformers_local.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->Tapas
...
# Copied from transformers_local.models.bert.modeling_bert.BertLMPredictionHead with Bert->Tapas
...
# Copied from transformers_local.models.bert.modeling_bert.BertOnlyMLMHead with Bert->Tapas
...
class TapasPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertPreTrainedModel._init_weights
