...
class FlaxSpeechEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    as decoder module when created with the :meth*~transformers_local.FlaxAutoModel.from_pretrained* class method for the
    ...
    def encode(
        ...
        ```python
        >>> from transformers_local import FlaxSpeechEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_local import FlaxSpeechEncoderDecoderModel, BartTokenizer
