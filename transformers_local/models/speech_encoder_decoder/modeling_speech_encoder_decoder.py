...
# Copied from transformers_local.models.encoder_decoder.modeling_encoder_decoder.shift_tokens_right
...
class SpeechEncoderDecoderModel(PreTrainedModel):
    ...
    :meth*~transformers_local.AutoModel.from_pretrained* class method for the encoder and
    :meth*~transformers_local.AutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import SpeechEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import SpeechEncoderDecoderModel, Wav2Vec2Processor
