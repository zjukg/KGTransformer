...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import Wav2Vec2FeatureExtractor, Wav2Vec2ForPreTraining
        >>> from transformers_local.models.wav2vec2.modeling_wav2vec2 import _compute_mask_indices
...
class Wav2Vec2ForMaskedLM(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import Wav2Vec2Processor, Wav2Vec2ForMaskedLM
        >>> from datasets import load_dataset
        >>> import soundfile as sf
        >>> import torch
