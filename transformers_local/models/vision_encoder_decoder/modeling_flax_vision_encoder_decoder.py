...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    another one as decoder module when created with the :meth*~transformers_local.FlaxAutoModel.from_pretrained* class method
    for the encoder and :meth*~transformers_local.FlaxAutoModelForCausalLM.from_pretrained* class method for the decoder.
    """
    ...
    def encode(
        ...
        ```python
        >>> from transformers_local import ViTFeatureExtractor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from transformers_local import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import FlaxVisionEncoderDecoderModel
