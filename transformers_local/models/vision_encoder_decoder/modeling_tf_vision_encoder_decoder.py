...
# Copied from transformers_local.models.encoder_decoder.modeling_tf_encoder_decoder.shift_tokens_right
...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers_local import TFVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import TFVisionEncoderDecoderModel
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
        >>> from PIL import Image
        >>> import requests
