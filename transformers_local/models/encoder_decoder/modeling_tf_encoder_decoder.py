...
class TFEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        >>> from transformers_local import EncoderDecoderModel, TFEncoderDecoderModel
        ...
        ```python
        >>> from transformers_local import TFEncoderDecoderModel
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import TFEncoderDecoderModel, BertTokenizer
