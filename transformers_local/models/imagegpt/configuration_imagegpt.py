...
class ImageGPTConfig(PretrainedConfig):
    ...
    Args:
        ...
        activation_function (`str`, *optional*, defaults to `"quick_gelu"`):
            Activation function (can be one of the activation functions defined in src/transformers_local/activations.py).
    ...
    ```python
    >>> from transformers_local import ImageGPTModel, ImageGPTConfig
