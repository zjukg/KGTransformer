...
class ImageGPTModel(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import ImageGPTFeatureExtractor, ImageGPTModel
...
class ImageGPTForCausalImageModeling(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import ImageGPTFeatureExtractor, ImageGPTForCausalImageModeling
        >>> import torch
...
class ImageGPTForImageClassification(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import ImageGPTFeatureExtractor, ImageGPTForImageClassification
        >>> from PIL import Image
        >>> import requests
