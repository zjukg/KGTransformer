...
# Copied from transformers_local.models.bert.modeling_bert.BertEmbeddings with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfAttention with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfOutput with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertAttention with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertIntermediate with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertOutput with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertLayer with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertEncoder with Bert->Realm
...
# Copied from transformers_local.models.bert.modeling_bert.BertPooler with Bert->Realm
...
class RealmEmbedder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import RealmTokenizer, RealmEmbedder
        >>> import torch
...
class RealmScorer(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import RealmTokenizer, RealmScorer
...
class RealmKnowledgeAugEncoder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import RealmTokenizer, RealmKnowledgeAugEncoder
...
class RealmForOpenQA(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import RealmForOpenQA, RealmRetriever, RealmTokenizer
