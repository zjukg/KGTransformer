...
class RagPreTrainedModel(PreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import RagModel
...
class RagModel(RagPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import RagTokenizer, RagRetriever, RagModel
        >>> import torch
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_local import RagTokenizer, RagRetriever, RagSequenceForGeneration
        >>> import torch
...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_local import RagTokenizer, RagRetriever, RagTokenForGeneration
        >>> import torch
