...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import RagTokenizer, RagRetriever, TFRagModel
        >>> import torch
        ...
        if encoder_outputs is None:
            ...
            if has_to_retrieve:
                ...
                # see https://github.com/huggingface/transformers_local/blob/master/src/transformers_local/models/dpr/modeling_tf_dpr.py#L91
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Adapted from https://github.com/huggingface/transformers_local/blob/master/src/transformers_local/modeling_tf_bart.py
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from transformers_local import RagTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from transformers_local import RagTokenizer, RagRetriever, TFRagSequenceForGeneration
