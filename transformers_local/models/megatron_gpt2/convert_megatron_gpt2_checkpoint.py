...
# PYTHONPATH=/tmp/Megatron-LM python src/transformers_local/models/megatron_gpt2/convert_megatron_gpt2_checkpoint.py ...
#
...
from transformers_local import AutoTokenizer, GPT2Config
...
def convert_megatron_checkpoint(args, input_state_dict, config):
    ...
    megatron_to_transformers_local = {
    ...
    for key, val in transformer.items():
        ...
        # Transpose the QKV matrix.
            ...
            # Megatron stores (3*D) x D but transformers_local-GPT2 expects D x 3*D.
        ...
        # Transpose the weights.
            ...
            out_name = megatron_to_transformers_local[op_name]
    ...
    # For LM head, transformers_local' wants the matrix to weight embeddings.
...
def main():
    ...
    # see https://github.com/huggingface/transformers_local/issues/13906)
    if ds_args is not None:
