...
# Copied from transformers_local.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Longformer
...
class LongformerModel(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import LongformerModel, LongformerTokenizer
...
class LongformerForMaskedLM(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import LongformerForMaskedLM, LongformerTokenizer
...
class LongformerForQuestionAnswering(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import LongformerTokenizer, LongformerForQuestionAnswering
        >>> import torch
