...
class XLNetConfig(PretrainedConfig):
    ...
    Args:
        ...
        mem_len (`int` or `None`, *optional*):
            ...
            [quickstart](https://huggingface.co/transformers_local/quickstart.html#using-the-past) for more information.
    ...
    ```python
    >>> from transformers_local import XLNetConfig, XLNetModel
