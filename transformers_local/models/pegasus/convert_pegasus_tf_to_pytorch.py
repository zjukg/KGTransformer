...
from transformers_local import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from transformers_local.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
