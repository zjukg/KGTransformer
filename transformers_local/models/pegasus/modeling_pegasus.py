...
# Copied from transformers_local.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->Pegasus
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Pegasus
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Pegasus
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import PegasusTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PegasusTokenizer, PegasusModel
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->Pegasus
...
class PegasusForCausalLM(PegasusPreTrainedModel):
    ...
    # Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM.forward with Bart->Pegasus, facebook/bart-large->google/pegasus-large
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
        ...
        ```python
        >>> from transformers_local import PegasusTokenizer, PegasusForCausalLM
