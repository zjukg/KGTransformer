...
# Copied from transformers_local.models.marian.modeling_tf_marian.TFMarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from transformers_local.models.bart.modeling_tf_bart.TFBartAttention with Bart->Pegasus
...
# Copied from transformers_local.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Pegasus
...
# Copied from transformers_local.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Pegasus
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import PegasusTokenizer, TFPegasusForConditionalGeneration
