...
class MT5Model(T5Model):
    ...
    ```python
    >>> from transformers_local import MT5Model, T5Tokenizer
...
class MT5ForConditionalGeneration(T5ForConditionalGeneration):
    ...
    ```python
    >>> from transformers_local import MT5ForConditionalGeneration, T5Tokenizer
...
class MT5EncoderModel(T5EncoderModel):
    ...
    ```python
    >>> from transformers_local import MT5EncoderModel, T5Tokenizer
