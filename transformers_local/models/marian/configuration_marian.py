...
class MarianConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_local import MarianModel, MarianConfig
...
class MarianOnnxConfig(OnnxSeq2SeqConfigWithPast):
    @property
    # Copied from transformers_local.models.bart.configuration_bart.BartOnnxConfig.inputs
    ...
    @property
    # Copied from transformers_local.models.bart.configuration_bart.BartOnnxConfig.outputs
    ...
    # Copied from transformers_local.models.bart.configuration_bart.BartOnnxConfig._flatten_past_key_values_
