...
from transformers_local import MarianConfig, MarianMTModel, MarianTokenizer
...
def get_system_metadata(repo_root):
    ...
    return dict(
        ...
        transformers_local_git_sha=git.Repo(path=".", search_parent_directories=True).head.object.hexsha,
