...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->Marian
...
# Copied from transformers_local.models.bart.modeling_bart.BartEncoderLayer with Bart->Marian
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderLayer with Bart->Marian
...
MARIAN_GENERATION_EXAMPLE = r"""
        ...
        ```python
        >>> from transformers_local import MarianTokenizer, MarianMTModel
...
class MarianModel(MarianPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import MarianTokenizer, MarianModel
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->Marian
...
# Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM with Bart->Marian, facebook/bart-large->Helsinki-NLP/opus-mt-fr-en
class MarianForCausalLM(MarianPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import MarianTokenizer, MarianForCausalLM
