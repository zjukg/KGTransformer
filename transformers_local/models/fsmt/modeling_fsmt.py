...
# - beam search: stops as soon as num_beams == len(hypos) (whereas transformers_local
#   is not satisfied there and will continue searching until the next cycles
#   aren't promising something better), comparing BLEU scores - the transformers_local
...
FSMT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import FSMTTokenizer, FSMTForConditionalGeneration
