...
from transformers_local import FSMTConfig, FSMTForConditionalGeneration
from transformers_local.file_utils import WEIGHTS_NAME
from transformers_local.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from transformers_local.tokenization_utils_base import TOKENIZER_CONFIG_FILE
...
def convert_fsmt_checkpoint_to_pytorch(fsmt_checkpoint_path, pytorch_dump_folder_path):
    ...
    print(f"transformers_local-cli upload {model_dir}")
