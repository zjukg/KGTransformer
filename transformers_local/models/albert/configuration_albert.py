...
class AlbertConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_local import AlbertConfig, AlbertModel
...
# Copied from transformers_local.models.bert.configuration_bert.BertOnnxConfig with Roberta->Albert
