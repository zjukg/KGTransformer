...
class XLMRobertaXLEmbeddings(nn.Module):
    ...
    # Copied from transformers_local.models.roberta.modeling_roberta.RobertaEmbeddings.create_position_ids_from_inputs_embeds
...
# Copied from transformers_local.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
class XLMRobertaXLModel(XLMRobertaXLPreTrainedModel):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertModel.__init__ with Bert->XLMRobertaXL
...
# Copied from transformers_local.models.roberta.modeling_roberta.create_position_ids_from_input_ids
