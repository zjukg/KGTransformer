...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers_local import XLMRobertaXLModel, XLMRobertaXLConfig
...
# Copied from transformers_local.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL
