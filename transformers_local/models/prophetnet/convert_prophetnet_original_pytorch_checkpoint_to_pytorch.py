...
from transformers_local import ProphetNetForConditionalGeneration, XLMProphetNetForConditionalGeneration, logging

# transformers_local_old should correspond to branch `save_old_prophetnet_model_structure` here
# original prophetnet_checkpoints are saved under `patrickvonplaten/..._old` respectively
from transformers_local_old.modeling_prophetnet import (
    ProphetNetForConditionalGeneration as ProphetNetForConditionalGenerationOld,
)
from transformers_local_old.modeling_xlm_prophetnet import (
