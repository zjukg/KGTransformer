...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ProphetNetTokenizer, ProphetNetEncoder
        >>> import torch
...
class ProphetNetDecoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ProphetNetTokenizer, ProphetNetDecoder
        >>> import torch
...
class ProphetNetModel(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ProphetNetTokenizer, ProphetNetModel
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ProphetNetTokenizer, ProphetNetForConditionalGeneration
    ...
    @staticmethod
    # Copied from transformers_local.models.bart.modeling_bart.BartForConditionalGeneration._reorder_cache
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ProphetNetTokenizer, ProphetNetForCausalLM
        >>> import torch
        ...
        >>> from transformers_local import BertTokenizer, EncoderDecoderModel, ProphetNetTokenizer
        >>> import torch
    ...
    @staticmethod
    # Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM._reorder_cache
    def _reorder_cache(past, beam_idx):
        reordered_past = ()
        for layer_past in past:
