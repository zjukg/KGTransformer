...
class TFConvNextEmbeddings(tf.keras.layers.Layer):
    ...
    found in src/transformers_local/models/swin/modeling_swin.py.
    """
...
class TFConvNextModel(TFConvNextPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import ConvNextFeatureExtractor, TFConvNextModel
...
class TFConvNextForImageClassification(TFConvNextPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import ConvNextFeatureExtractor, TFConvNextForImageClassification
        >>> import tensorflow as tf
        >>> from PIL import Image
        >>> import requests
