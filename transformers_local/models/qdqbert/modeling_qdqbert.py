...
# Copied from transformers_local.models.bert.modeling_bert.BertEmbeddings with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertAttention with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertLayer with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertEncoder with Bert -> QDQBert
...
# Copied from transformers_local.models.bert.modeling_bert.BertPooler with Bert -> QDQBert
...
# Copied from transformers_local.models.bert.modeling_bert.BertPredictionHeadTransform with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertLMPredictionHead with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertOnlyMLMHead with Bert -> QDQBert
...
# Copied from transformers_local.models.bert.modeling_bert.BertOnlyNSPHead with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertPreTrainingHeads with Bert -> QDQBert
...
# Based on transformers_local.models.bert.modeling_bert.BertPreTrainedModel with Bert -> QDQBert
...
class QDQBertLMHeadModel(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import BertTokenizer, QDQBertLMHeadModel, QDQBertConfig
        >>> import torch
...
class QDQBertForNextSentencePrediction(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import BertTokenizer, QDQBertForNextSentencePrediction
        >>> import torch
