...
LXMERT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        visual_feats: (`tf.Tensor` of shape `(batch_size, num_visual_features, visual_feat_dim)`):
            ...
            These are currently not provided by the transformers_local library.
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertPredictionHeadTransform with Bert->Lxmert
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertLMPredictionHead with Bert->Lxmert
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMLMHead with Bert->Lxmert
