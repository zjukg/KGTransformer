...
class CLIPTextModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import CLIPTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers_local import CLIPProcessor, CLIPVisionModel
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_local import CLIPTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_local import CLIPProcessor, CLIPModel
