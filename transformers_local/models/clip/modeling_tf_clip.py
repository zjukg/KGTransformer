...
class TFCLIPAttention(tf.keras.layers.Layer):
    ...
    # copied from transformers_local.models.bert.modeling_tf_bert.TFBertSelfAttention.transpose_for_scores
...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import CLIPTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        >>> import requests
        >>> from transformers_local import CLIPProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import CLIPTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        **kwargs,
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers_local import CLIPProcessor, TFCLIPModel
