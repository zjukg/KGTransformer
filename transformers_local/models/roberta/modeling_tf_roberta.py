...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertPooler with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertSelfAttention with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertSelfOutput with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertAttention with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertOutput with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertLayer with Bert->Roberta
...
# Copied from transformers_local.models.bert.modeling_tf_bert.TFBertEncoder with Bert->Roberta
...
class TFRobertaMainLayer(tf.keras.layers.Layer):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMainLayer.get_input_embeddings
    def get_input_embeddings(self) -> tf.keras.layers.Layer:
        return self.embeddings

    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMainLayer.set_input_embeddings
    def set_input_embeddings(self, value: tf.Variable):
        self.embeddings.weight = value
        self.embeddings.vocab_size = shape_list(value)[0]

    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMainLayer._prune_heads
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertMainLayer.call
    def call(
        self,
...
class TFRobertaPreTrainedModel(TFPreTrainedModel):
    ...
    @property
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertPreTrainedModel.dummy_inputs
...
class TFRobertaModel(TFRobertaPreTrainedModel):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertModel.serving_output
    def serving_output(
...
class TFRobertaForMaskedLM(TFRobertaPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForMaskedLM.serving_output
...
class TFRobertaForCausalLM(TFRobertaPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertLMHeadModel.prepare_inputs_for_generation
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertLMHeadModel.serving_output
...
class TFRobertaForSequenceClassification(TFRobertaPreTrainedModel, TFSequenceClassificationLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForSequenceClassification.serving_output
...
class TFRobertaForMultipleChoice(TFRobertaPreTrainedModel, TFMultipleChoiceLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForMultipleChoice.serving_output
...
class TFRobertaForTokenClassification(TFRobertaPreTrainedModel, TFTokenClassificationLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForTokenClassification.serving_output
...
class TFRobertaForQuestionAnswering(TFRobertaPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    # Copied from transformers_local.models.bert.modeling_tf_bert.TFBertForQuestionAnswering.serving_output
