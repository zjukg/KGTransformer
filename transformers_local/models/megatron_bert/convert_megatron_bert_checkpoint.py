...
# PYTHONPATH=/tmp/Megatron-LM python src/transformers_local/models/megatron_bert/convert_megatron_bert_checkpoint.py ...
#
...
from transformers_local import MegatronBertConfig
