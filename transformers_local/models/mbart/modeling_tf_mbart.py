...
# Copied from transformers_local.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformers_local.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
    ...
    ```python
    >>> from transformers_local import MBartTokenizer, TFMBartForConditionalGeneration
