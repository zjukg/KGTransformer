...
# Copied from transformers_local.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import MBartTokenizer, MBartForConditionalGeneration
...
class MBartForQuestionAnswering(MBartPreTrainedModel):
    ...
    # Copied from transformers_local.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM with Bart->MBart, facebook/bart-large->facebook/mbart-large-cc25
class MBartForCausalLM(MBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import MBartTokenizer, MBartForCausalLM
