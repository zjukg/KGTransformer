...
FROM_CONFIG_DOCSTRING = """
        ...
        ```python
        >>> from transformers_local import AutoConfig, BaseAutoModelClass
...
def getattribute_from_module(module, attr):
    ...
    return getattribute_from_module(transformers_local_module, attr)
...
class _LazyAutoMapping(OrderedDict):
    ...
    def _load_attr_from_module(self, model_type, attr):
        ...
        if module_name not in self._modules:
            self._modules[module_name] = importlib.import_module(f".{module_name}", "transformers_local.models")
