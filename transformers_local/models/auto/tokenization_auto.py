...
if TYPE_CHECKING:
    ...
    # the transformers_local package is used with Microsoft's Pylance language server.
...
def tokenizer_class_from_name(class_name: str):
    ...
    for module_name, tokenizers in TOKENIZER_MAPPING_NAMES.items():
        if class_name in tokenizers:
            ...
            module = importlib.import_module(f".{module_name}", "transformers_local.models")
...
def get_tokenizer_config(
    ...
    **kwargs,
    ...
    from transformers_local import AutoTokenizer
