...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->Speech2Text
...
class Speech2TextModel(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ...
         ```python
         >>> import torch
         >>> from transformers_local import Speech2TextModel, Speech2TextFeatureExtractor
...
class Speech2TextForConditionalGeneration(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers_local import Speech2TextProcessor, Speech2TextForConditionalGeneration
        >>> from datasets import load_dataset
