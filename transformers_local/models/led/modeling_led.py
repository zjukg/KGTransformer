...
# Copied from transformers_local.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from transformers_local.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from transformers_local import LEDTokenizer, LEDForConditionalGeneration
...
class LEDModel(LEDPreTrainedModel):
    ...
    def forward(
        ...
        # https://github.com/huggingface/transformers_local/blob/ac3cb660cad283163f7c73cad511124e845ca388/src/transformers_local/models/bart/modeling_bart.py#L1153
