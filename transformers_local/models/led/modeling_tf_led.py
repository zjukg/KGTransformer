...
# Copied from transformers_local.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from transformers_local.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import LEDTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
