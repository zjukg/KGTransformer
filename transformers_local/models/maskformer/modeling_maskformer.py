...
@dataclass
# Copied from transformers_local.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from transformers_local.models.vit.modeling_vit.to_2tuple
def to_2tuple(x):
...
# Copied from transformers_local.models.swin.modeling_swin.window_partition
...
# Copied from transformers_local.models.swin.modeling_swin.window_reverse
...
# Copied from transformers_local.models.swin.modeling_swin.drop_path
...
# Copied from transformers_local.models.swin.modeling_swin.SwinDropPath with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.swin.modeling_swin.SwinSelfAttention with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.swin.modeling_swin.SwinSelfOutput with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.swin.modeling_swin.SwinAttention with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.swin.modeling_swin.SwinIntermediate with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.swin.modeling_swin.SwinOutput with Swin->MaskFormerSwin
...
# Copied from transformers_local.models.detr.modeling_detr.DetrAttention
...
# Copied from transformers_local.models.detr.modeling_detr.DetrDecoderLayer
...
# Copied from transformers_local.models.detr.modeling_detr._expand_mask
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import MaskFormerFeatureExtractor, MaskFormerForInstanceSegmentation
