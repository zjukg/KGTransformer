...
from transformers_local.models.maskformer.feature_extraction_maskformer import MaskFormerFeatureExtractor
from transformers_local.models.maskformer.modeling_maskformer import (
    MaskFormerConfig,
