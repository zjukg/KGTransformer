...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
