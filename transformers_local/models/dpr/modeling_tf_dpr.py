...
class TFDPRContextEncoder(TFDPRPretrainedContextEncoder):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import TFDPRContextEncoder, DPRContextEncoderTokenizer
...
class TFDPRQuestionEncoder(TFDPRPretrainedQuestionEncoder):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class TFDPRReader(TFDPRPretrainedReader):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import TFDPRReader, DPRReaderTokenizer
