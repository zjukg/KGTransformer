...
# Copied from transformers_local.models.clip.modeling_clip.contrastive_loss
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from transformers_local.models.clip.modeling_clip.clip_loss
...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from transformers_local import VisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from transformers_local import VisionTextDualEncoderModel, AutoFeatureExtractor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import VisionTextDualEncoderModel
