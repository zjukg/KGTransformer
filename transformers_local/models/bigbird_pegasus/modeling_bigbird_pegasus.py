...
# Copied from transformers_local.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_local.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(nn.Module):
    ...
    # Copied from transformers_local.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from transformers_local.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import PegasusTokenizer, BigBirdPegasusForConditionalGeneration
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod  # Copied from transformers_local.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
class BigBirdPegasusDecoder(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from transformers_local.models.bart.modeling_bart.BartDecoder._prepare_decoder_attention_mask
...
# Copied from transformers_local.models.bart.modeling_bart.BartModel with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from transformers_local.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from transformers_local.models.bart.modeling_bart.BartForSequenceClassification with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from transformers_local.models.bart.modeling_bart.BartForQuestionAnswering with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from transformers_local.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PegasusTokenizer, BigBirdPegasusForCausalLM
