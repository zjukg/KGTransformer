...
class TFT5Model(TFT5PreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import T5Tokenizer, TFT5Model
...
class TFT5ForConditionalGeneration(TFT5PreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import T5Tokenizer, TFT5ForConditionalGeneration
...
class TFT5EncoderModel(TFT5PreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_local import T5Tokenizer, TFT5EncoderModel
