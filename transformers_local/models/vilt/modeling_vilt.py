...
# Copied from transformers_local.models.vit.modeling_vit.ViTSelfOutput with ViT->Vilt
...
# Copied from transformers_local.models.vit.modeling_vit.ViTIntermediate with ViT->Vilt
...
# Copied from transformers_local.models.vit.modeling_vit.ViTOutput with ViT->Vilt
...
class ViltModel(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ViltProcessor, ViltModel
...
class ViltForMaskedLM(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ViltProcessor, ViltForMaskedLM
        >>> import requests
        >>> from PIL import Image
        >>> import re
...
class ViltForQuestionAnswering(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ViltProcessor, ViltForQuestionAnswering
        >>> import requests
        >>> from PIL import Image
...
class ViltForImageAndTextRetrieval(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ViltProcessor, ViltForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class ViltForImagesAndTextClassification(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import ViltProcessor, ViltForImagesAndTextClassification
        >>> import requests
        >>> from PIL import Image
