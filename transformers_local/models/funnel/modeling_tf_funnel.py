...
class TFFunnelBaseModel(TFFunnelPreTrainedModel):
    ...
    # Copied from transformers_local.models.distilbert.modeling_tf_distilbert.TFDistilBertModel.serving_output
...
class TFFunnelForPreTraining(TFFunnelPreTrainedModel):
    ...
    def call(
        ...
        **kwargs
        ...
        ```python
        >>> from transformers_local import FunnelTokenizer, TFFunnelForPreTraining
        >>> import torch
