...
# Copied from transformers_local.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->Data2VecText
class Data2VecTextForTextEmbeddings(nn.Module):
    """
    Same as BertEmbeddings with a tiny tweak for positional embeddings indexing.
    """

    # Copied from transformers_local.models.bert.modeling_bert.BertEmbeddings.__init__
...
# Copied from transformers_local.models.roberta.modeling_roberta.RobertaSelfAttention with Roberta->Data2VecText
...
# Copied from transformers_local.models.bert.modeling_bert.BertAttention with Bert->Data2VecText
...
# Copied from transformers_local.models.bert.modeling_bert.BertLayer with Bert->Data2VecText
...
# Copied from transformers_local.models.bert.modeling_bert.BertEncoder with Bert->Data2VecText
...
class Data2VecTextModel(Data2VecTextPreTrainedModel):
    ...
    # Copied from transformers_local.models.bert.modeling_bert.BertModel.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
class Data2VecTextForCausalLM(Data2VecTextPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import Data2VecTextTokenizer, Data2VecTextForCausalLM, Data2VecTextConfig
        >>> import torch
...
# Copied from transformers_local.models.roberta.modeling_roberta.RobertaLMHead with Roberta->Data2VecText
...
# Copied from transformers_local.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Data2VecText
