...
from transformers_local import Data2VecTextConfig, Data2VecTextForMaskedLM, Data2VecTextForSequenceClassification
from transformers_local.models.bert.modeling_bert import (
    BertIntermediate,
    BertLayer,
    BertOutput,
    BertSelfAttention,
...
from transformers_local.models.data2vec.data2vec_text import Data2VecTextModel
