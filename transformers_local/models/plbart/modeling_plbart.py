...
# Copied from transformers_local.models.mbart.modeling_mbart.shift_tokens_right
...
# Copied from transformers_local.models.bart.modeling_bart._make_causal_mask
...
# Copied from transformers_local.models.bart.modeling_bart._expand_mask
...
# Copied from transformers_local.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartEncoderLayer with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderLayer with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartClassificationHead with Bart->PLBart
...
PLBART_GENERATION_EXAMPLE = r"""
    Token in-filling example:
        ...
        >>> from transformers_local import PLBartTokenizer, PLBartForConditionalGeneration, PLBartConfig
    ...
    Mask-filling example:
        ...
        >>> from transformers_local import PLBartTokenizer, PLBartForConditionalGeneration >>> tokenizer =
...
# Copied from transformers_local.models.bart.modeling_bart.BartEncoder with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoder with Bart->PLBart
...
class PLBartForSequenceClassification(PLBartPreTrainedModel):
    ...
    # Copied from transformers_local.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
...
# Copied from transformers_local.models.bart.modeling_bart.BartDecoderWrapper with Bart->PLBart
...
# Copied from transformers_local.models.bart.modeling_bart.BartForCausalLM with Bart->PLBart
class PLBartForCausalLM(PLBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers_local import PLBartTokenizer, PLBartForCausalLM
