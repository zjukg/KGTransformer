...
# Copied from transformers_local.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100
...
# Copied from transformers_local.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100
...
M2M_100_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from transformers_local import M2M100Tokenizer, M2M100ForConditionalGeneration
