...
class M2M100Config(PretrainedConfig):
    ...
    ```python
    >>> from transformers_local import M2M100Model, M2M100Config
...
class M2M100OnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    # Copied from transformers_local.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_default_and_seq2seq_lm
