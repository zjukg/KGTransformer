...
class BatchFeature(UserDict):
    ...
    # Copied from transformers_local.tokenization_utils_base.BatchEncoding.keys
    def keys(self):
        return self.data.keys()

    # Copied from transformers_local.tokenization_utils_base.BatchEncoding.values
    def values(self):
        return self.data.values()

    # Copied from transformers_local.tokenization_utils_base.BatchEncoding.items
    def items(self):
    ...
    @torch_required
    # Copied from transformers_local.tokenization_utils_base.BatchEncoding.to with BatchEncoding->BatchFeature
    ...
    def get_feature_extractor_dict(
        ...
        try:
            ...
            raise EnvironmentError(
                ...
                "offline mode at 'https://huggingface.co/docs/transformers_local/installation#offline-mode'."
            )
