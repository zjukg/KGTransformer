...
class LoginCommand(BaseUserCommand):
    def run(self):
        print(
            ANSI.red(
                "WARNING! `transformers_local-cli login` is deprecated and will be removed in v5. Please use "
...
class WhoamiCommand(BaseUserCommand):
    def run(self):
        print(
            ANSI.red(
                "WARNING! `transformers_local-cli whoami` is deprecated and will be removed in v5. Please use "
...
class LogoutCommand(BaseUserCommand):
    def run(self):
        print(
            ANSI.red(
                "WARNING! `transformers_local-cli logout` is deprecated and will be removed in v5. Please use "
...
class RepoCreateCommand(BaseUserCommand):
    def run(self):
        print(
            ANSI.red(
                "WARNING! Managing repositories through transformers_local-cli is deprecated. "
