...
class GenerationMixin:
    ...
    def _get_logits_warper(
        ...
        # the following idea is largely copied from this PR: https://github.com/huggingface/transformers_local/pull/5420/files
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        ```python
        >>> from transformers_local import AutoTokenizer, AutoModelForCausalLM, AutoModelForSeq2SeqLM
