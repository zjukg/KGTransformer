...
class Trainer:
    ...
    Important attributes:
        ...
        - **model** -- Always points to the core model. If using a transformers_local model, it will be a [`PreTrainedModel`]
          subclass.
    ...
    def get_optimizer_cls_and_kwargs(args: TrainingArguments) -> Tuple[Any, Any]:
        ...
        Args:
            args (`transformers_local.training_args.TrainingArguments`):
    ...
    def _hp_search_setup(self, trial: Union["optuna.Trial", Dict[str, Any]]):
        ...
        if self.args.deepspeed:
            ...
            from transformers_local.deepspeed import HfDeepSpeedConfig
    ...
    def _wrap_model(self, model, training=True):
        ...
        if self.sharded_ddp is not None:
            ...
            if self.args.ddp_find_unused_parameters is not None:
                ...
                # https://github.com/huggingface/transformers_local/pull/4659#issuecomment-643356021
        ...
        **kwargs,
        ...
        if resume_from_checkpoint is not None:
            ...
            if os.path.isfile(os.path.join(resume_from_checkpoint, CONFIG_NAME)):
                ...
                checkpoint_version = config.transformers_local_version
