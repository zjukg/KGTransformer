...
class ModuleUtilsMixin:
    ...
    def floating_point_ops(
        ...
        paper](https://arxiv.org/pdf/2001.08361.pdf) section 2.1. Should be overridden for transformers_local with parameter
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        Parameters:
            ...
            torch_dtype (`str` or `torch.dtype`, *optional*):
                ...
                One should only disable *_fast_init* to ensure backwards compatibility with `transformers_local.__version__ <
                4.6.0` for seeded model initialization. This argument will be removed at the next major version. See
                [pull request 11471](https://github.com/huggingface/transformers_local/pull/11471) for more information.
        ...
        Activate the special ["offline-mode"](https://huggingface.co/transformers_local/installation.html#offline-mode) to
        ...
        ```python
        >>> from transformers_local import BertConfig, BertModel
