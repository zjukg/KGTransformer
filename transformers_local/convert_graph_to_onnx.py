...
from transformers_local.file_utils import ModelOutput, is_tf_available, is_torch_available
from transformers_local.pipelines import Pipeline, pipeline
...
class OnnxConverterArgumentParser(ArgumentParser):
    """
    Wraps all the script arguments supported to export transformers_local models to ONNX IR
    """
...
def convert(
    ...
    **model_kwargs
    ...
    """
    warnings.warn(
        "The `transformers_local.convert_graph_to_onnx` package is deprecated and will be removed in version 5 of Transformers",
        FutureWarning,
    )
        ...
        if args.quantize:
            ...
            if args.framework == "tf":
                print(
                    ...
                    "\t\thttps://github.com/microsoft/onnxruntime/tree/master/onnxruntime/python/tools/transformers_local\n"
                )
