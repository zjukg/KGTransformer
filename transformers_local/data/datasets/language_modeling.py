    ...
    def __init__(
        ...
        warnings.warn(
            DEPRECATION_WARNING.format(
                "https://github.com/huggingface/transformers_local/blob/master/examples/pytorch/language-modeling/run_mlm.py"
            ),
            FutureWarning,
        )
...
class LineByLineWithRefDataset(Dataset):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, file_path: str, block_size: int, ref_path: str):
        warnings.warn(
            DEPRECATION_WARNING.format(
                "https://github.com/huggingface/transformers_local/blob/master/examples/pytorch/language-modeling/run_mlm_wwm.py"
            ),
            FutureWarning,
        )
        if os.path.isfile(file_path) is False:
